	...
	public partial class Equipment : UserControl
	{
		...
		public Equipment()
		{
            ...
            Item weapon1 = new ItemBuilder(ItemCategory.Weapon)
                .AddName("Weapon One")
                .AddDescription("This is a fancy weapon")
            ...
            Item artifact = new ItemBuilder(ItemCategory.Artifact)
                .AddName("Artifact")
                .AddDescription("This is an artifact")
                .AddEquipmentComponent(ItemRarity.Epic)
                .AddRequirements(1, 10, 10, 10)
            ...
            Item weapon2 = new ItemBuilder(ItemCategory.Weapon)
                .AddName("Weapon Two")
                .AddDescription("This is another fancy weapon")
                .AddEquipmentComponent(ItemRarity.Legendary)
                .AddRequirements(1, 10, 10, 10)
                .AddItemVersion(ItemVersion.Original)
                .AddLocation(0, 0)
            ...
            Item necklace = new ItemBuilder(ItemCategory.Gear)
                .AddName("Necklace")
                .AddDescription("I am a necklace")
            ...
            Item torso = new ItemBuilder(ItemCategory.Gear)
                .AddName("Torso")
                .AddDescription("I am torso armor")
                .AddEquipmentComponent(ItemRarity.Epic)
                .AddRequirements(1, 10, 10, 10)
                .AddLocation(0,0)
                .AddSize(2, 3)
            ...
            Item ring2 = new ItemBuilder(ItemCategory.Gear)
                .AddName("Ring two")
                .AddDescription("I am another ring")
                .AddEquipmentComponent(ItemRarity.Epic)
                .AddRequirements(1, 10, 10, 10)
                .AddLocation(0,0)
                .AddSize(2, 1)
            ...
            Item shield1 = new ItemBuilder(ItemCategory.Weapon)
                .AddName("Shield1")
                .AddDescription("I am a cool shield")
                .AddEquipmentComponent(ItemRarity.Broken)
                .AddRequirements(1, 10, 10, 10)
                .AddLocation(0,0)
                .AddSize(2, 4)
                .AddIcon((BitmapImage)ImagePaths.ItemMocks.TwoByFour)
            ...
            Item shield2 = new ItemBuilder(ItemCategory.Weapon)
                .AddName("Shield two")
                .AddDescription("I am another super cool shield")
                .AddEquipmentComponent(ItemRarity.Legendary)
                .AddLocation(0,0)
                .AddSize(2, 4)
                .AddIcon((BitmapImage)ImagePaths.ItemMocks.TwoByFour)
