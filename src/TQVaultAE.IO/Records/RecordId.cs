...
namespace TQVaultAE.IO.Records
{
    public partial class RecordId : IEquatable<RecordId>, IComparable, IComparable<RecordId>
    {
        ...
        /// <returns></returns>
        public static RecordId Create(string rawRecordId) => new(rawRecordId);
        ...
        private (string PrettyFileName, string Effect, string Number, bool IsMatch) _prettyFileNameExploded = default!;
