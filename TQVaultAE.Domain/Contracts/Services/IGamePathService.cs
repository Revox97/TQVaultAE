...
public interface IGamePathService
{
	...
	/// <returns></returns>
	string ArchiveTogglePath(string oldPath);
	...
	/// </summary>
	bool IsEternalEmbersInstalled { get; }
	...
	/// </summary>
	string GamePathTitanQuest { get; set; }

	/// <summary>
	/// Gets the Titan Quest Character save folder.
	/// Resolve as "%USERPROFILE%\Documents\My Games\Titan Quest".
	/// </summary>
	string SaveFolderTitanQuest { get; }

	/// <summary>
	/// Gets the name of the game settings file.
	/// </summary>
	string SettingsFileTitanQuest { get; }

	/// <summary>
	/// Gets the name of the game settings file.
	/// </summary>
	string SettingsFileImmortalThrone { get; }
	...
	/// </summary>
	bool HasVaultFolderChanged { get; }
	...
	/// </summary>
	/// <param name="isImmortalThrone">if <c>true</c> return an "Immortal Throne" path. Return an "Titan Quest" otherwise.</param>
	/// <param name="isArchive">if <c>true</c> return an Archive path.</param>
	/// <returns>path of the save folder</returns>
	string GetBaseCharacterFolder(bool isImmortalThrone, bool isArchive);
	...
	/// <param name="isArchive">if <c>true</c> return an Archive path.</param>
	/// <returns>path of the save folder</returns>
	string GetBaseCharacterFolder(bool isImmortalThrone, bool isCustomCharacter, bool isArchive);
	...
	/// <param name="isImmortalThrone"><c>true</c> for Immortal Throne file, <c>false</c> otherwise</param>
	/// <param name="isArchive">if <c>true</c> return an Archive path.</param>
	/// <returns>full path to the character file.</returns>
	string GetPlayerFile(string characterName, bool isImmortalThrone, bool isArchive);
