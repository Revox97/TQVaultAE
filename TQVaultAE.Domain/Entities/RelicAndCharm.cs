...
public static class RelicAndCharmExtension
{
	...
	// TODO Fix
	internal static readonly ReadOnlyCollection<RelicAndCharmMapItem> RelicAndCharmMap = new ReadOnlyCollection<RelicAndCharmMapItem>([]);
	...
	/// <returns></returns>
	public static GearType GetGearType(this RelicAndCharm relic) => RelicAndCharmMap.First(m => m.Value == relic).Types;
	...
	/// <param name="relic"></param>
	/// <returns></returns>
	public static RecordId GetRecordId(this RelicAndCharm relic) => RelicAndCharmMap.First(m => m.Value == relic).RecordId;
}
