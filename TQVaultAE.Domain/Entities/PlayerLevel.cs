namespace TQVaultAE.Domain.Entities
{
	public class PlayerLevel
	{
		...
		public static int MinEnergy => 300;
		...
		// TODO Yes more magic numbers
		private static readonly Dictionary<int, int> s_levelKey = new() {
			{1    ,       0},
			{2    ,     621},
			{3    ,    2315},
			{4    ,    5891},
		...
		{
			if (s_levelKey.TryGetValue(level, out int value))
				return (value);

			throw new ArgumentOutOfRangeException(nameof(level), "Level does not exist or is not supported");
		}
	}
}
